...
- **Events & Activities**:
    - **Regular Activities**: Ongoing community service initiatives.
    - **Special Camps**: Information on focused, intensive service camps.
    - **Weeks & Days**: Celebration of significant national and international days.
- **Media & Gallery**:
    - **Photos**: A collection of images from various events.
    - **Videos**: Video coverage of NSS activities.
- **Team**:
    - **Program Officers**: Profiles of the dedicated officers leading the unit.
    - **Volunteers**: Recognition of active student volunteers.
- **Join Us**:
    - **Joining Form**: Online application for students to join NSS.
...
- **[Lenis](https://github.com/darkroomengineering/lenis)**: A library for smooth scrolling.
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/Shevilll/aujnss.git
    cd aujnss
    ```
